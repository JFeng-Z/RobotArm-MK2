...
data_t BaseAngle_data = {
    .name = "Base Angle",
    .ptr = &ArmRobotAngle.Base_Angle,
...
data_t BigArmAngle_data = {
    .name = "BigArm Angle",
    .ptr = &ArmRobotAngle.BigArm_Angle,
    .function = SetBigArmAngle,
    .Function_Type = STEP_EXECUTE,
    .Data_Type = DATA_INT,
    .max = 180,
    .min = 0,
...
data_t ForearmAngle_data = {
    .name = "Forearm Angle",
    .ptr = &ArmRobotAngle.Forearm_Angle,
    .function = SetForearmAngle,
    .Function_Type = STEP_EXECUTE,
    .Data_Type = DATA_INT,
    .max = 180,
    .min = 0,
